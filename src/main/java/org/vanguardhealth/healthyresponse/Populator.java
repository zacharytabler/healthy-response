...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Mood afraid = new Mood("Afraid", "https://i.ibb.co/GH1BM9j/Afraid.png", "Healthy Response is not a diagnostic tool. Only a trained medical professional, like a doctor or mental health professional, can help you determine the next best steps for you.\n","<a href=https://www.verywellmind.com/the-psychology-of-fear-2671696 target=_blank>What is Fear?</a>", "<a href=https://psychcentral.com/quizzes/anxiety-quiz#1 target=_blank>PsychCentral: Anxiety Screening Test</a>",
